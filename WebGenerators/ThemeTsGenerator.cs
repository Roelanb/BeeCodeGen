...
public class ThemeTsGenerator : BaseGenerator, IFileGenerator
{
    public ThemeTsGenerator(NpgsqlConnection connection) : base(connection)
    {
    }
...
export const useMode = (): [Theme, ColorModeContextType] => {
  ...
  return [theme, colorMode];
        ...
        var filePath = Path.Combine(projectPath, "src", "theme.ts");
